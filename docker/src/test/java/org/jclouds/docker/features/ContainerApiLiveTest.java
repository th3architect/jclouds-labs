...
public class ContainerApiLiveTest extends BaseDockerApiLiveTest {
   ...
   public void testListContainers() {
      Set<ContainerSummary> containerSummaries = api().listContainers(ListContainerOptions.Builder.all(true));
      for (ContainerSummary containerSummary : containerSummaries) {
         assertNotNull(containerSummary.getId());
         assertNotNull(containerSummary.getImage());
         assertFalse(containerSummary.getNames().isEmpty());
      }
   }
