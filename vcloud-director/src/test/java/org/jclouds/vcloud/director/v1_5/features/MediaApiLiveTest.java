...
public class MediaApiLiveTest extends BaseVCloudDirectorApiLiveTest {
   ...
   public void testCloneMedia() {
      ...
      api.getMetadataApi(media.getId()).put("key", "value");
   ...
   public void testGetMetadata() {
      metadata = api.getMetadataApi(media.getId()).get();
   ...
   public void testMergeMetadata() {
      // test new
      Task mergeMetadata = api.getMetadataApi(media.getId()).putAll(ImmutableMap.of("testKey", "testValue"));
      ...
      // test edit
      mergeMetadata = api.getMetadataApi(media.getId()).put("testKey", "new testValue");
      Checks.checkTask(mergeMetadata);
   ...
   public void testGetMetadataValue() {
      metadataValue = api.getMetadataApi(media.getId()).get("key");
   ...
   public void testSetMetadataValue() {
      ...
      Task setMetadataEntry = api.getMetadataApi(media.getId()).put("key", metadataEntryValue);
   ...
   public void testRemoveMetadata() {
      Task remove = api.getMetadataApi(media.getId()).remove("testKey");
      Checks.checkTask(remove);
      assertTrue(retryTaskSuccess.apply(remove), String.format(TASK_COMPLETE_TIMELY, "remove"));

      metadataValue = api.getMetadataApi(media.getId()).get("testKey");
