...
public class VirtualMachine {
   ...
   @ConstructorProperties({ "Id", "Name", "Created", "Path", "Args", "Config", "State", "Image", "NetworkSettings",
           ...
           "Ports", "HostnamePath" })
   protected VirtualMachine(String id, @Nullable String name, @Nullable String created, @Nullable String path, @Nullable String[] args,
   ...
   public static final class Builder {
      ...
      public VirtualMachine build() {
         return new VirtualMachine(id, name, created, path, args, containerConfig, state, image, networkSettings, resolvConfPath,
                 driver, execDriver, volumes, volumesRW, command, status, hostConfig, ports, hostnamePath);
      }
