 ...
 */
package org.jclouds.xstream.internal;
...
/**
 * Base class for all Virtustream xStream mock tests.
 */
public class BaseXStreamMockTest {
   ...
   public BaseXStreamMockTest() {
      provider = "xstream";
   }

   public XStreamApi api(URL url) {
      return ContextBuilder.newBuilder(provider)
            .credentials("clientid", "apikey")
            .endpoint(url.toString())
            .modules(modules) 
            .overrides(setupProperties()) 
            .buildApi(XStreamApi.class);
   }
