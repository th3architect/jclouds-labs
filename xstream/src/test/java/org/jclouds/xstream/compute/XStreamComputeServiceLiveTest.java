 ...
 */
package org.jclouds.xstream.compute;
 ...
 */
@Test(groups = "live", singleThreaded = true, testName = "XStreamComputeServiceLiveTest")
public class XStreamComputeServiceLiveTest extends BaseComputeServiceLiveTest {

   private static final String DEFAULT_JCLOUDS_IMAGE = "jclouds/default";
   private Image defaultImage;

   public XStreamComputeServiceLiveTest() {
      provider = "docker";
   }
   ...
   public void testOptionToNotBlock() throws Exception {
      // XStream ComputeService implementation has to block until the node
      // is provisioned, to be able to return it.
   }

   @Override
   protected void checkTagsInNodeEquals(NodeMetadata node, ImmutableSet<String> tags) {
      // XStream does not support tags
   }

   @Override
   protected void checkUserMetadataContains(NodeMetadata node, ImmutableMap<String, String> userMetadata) {
      // XStream does not support user metadata
   }

   @Override
   public void testCreateAndRunAService() throws Exception {
      // XStream does not support blockOnPort
   }
   ...
   public void testCorrectAuthException() throws Exception {
      // XStream does not support authentication yet
